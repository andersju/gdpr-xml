...
<html lang="en">
  <head>
    ...
    <meta name="description" content="The GDPR (including corrections) in all the 24 languages of the EU.">
    <title>GDPR in all 24 EU languages</title>
    <link rel="stylesheet" href="style.css">
  </head>
  <body>
  <header>
    <h1>GDPR in all 24 EU languages</h1>
  </header>
